...
- query demo. map tools, re-color and re-filter layers, zoom. 
- voice demo
- show hexes

- show a debug pipeline
- show use of the mcp tool from claude code

- show data workflows ingest pipeline

- Discuss stakeholders groups
